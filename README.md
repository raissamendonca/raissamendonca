...
I'm Raissa (🔉 ha-ee-sah) Mendonca. I'm the lead data manager for the [*H2Ohio Wetland Monitoring Program*](https://h2.ohio.gov/natural-resources/), which is a branch of the state-wide, collaborative [*H2Ohio*](https://h2.ohio.gov/) water quality initiative. As part of the WMP team I'm specifically tasked with building tools for complete and consistent (meta)data collection using Esri Survey123, creating automated quality control steps for all our data streams using Python and GitHub Actions, and mucking around in some cool wetlands when I can 😄. I got my PhD in Ecology at Kent State University researching nickel biogeochemistry in stream systems, specifically looking at the role of metal oxides on [*nickel bioavailability*](https://pubs.acs.org/doi/10.1021/acs.est.7b03718) ([*thompson repo*](https://github.com/raissamendonca/thompson)), [*nickel partitioning*](https://academic.oup.com/etc/article/44/7/1847/8124371?utm_source=authortollfreelink&utm_campaign=etc&utm_medium=email&guestAccessKey=db5e4e78-9288-497a-a097-75120e533402) ([*oxicni repo*](https://github.com/raissamendonca/oxicni-pub)), and [*microbial ecotoxicology*](https://doi.org/10.1111/1462-2920.16529) ([*redox-tox repo*](https://github.com/raissamendonca/gb1-redox-tox)).
